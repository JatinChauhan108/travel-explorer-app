  ...
  return (
    <div>
      <label htmlFor={inputLabel} className="relative">
        ...
        <span
          className="absolute inset-y-0 start-3 -translate-y-10 bg-white px-0.5 text-sm font-medium text-gray-700 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5 dark:bg-gray-900 dark:text-white"
        >
          {inputLabel}
        </span>
      </label>
